...
Define the canonical requirements for browser-based audio transcription, including file intake, Web Worker transcription, model loading, progress reporting, error handling, and language detection.
